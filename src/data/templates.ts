...
export const templates: Template[] = [
  ...
  // ===== DESPEDIDAS DE SOLTERO/A =====
  {
    ...
    name: "Labios Neon",
    category: "Neon",
    description: "Boca con labial rojo sobre fondo negro. Neon, sensual y fiestero.",
    type: "despedida",
    style: "labiosneon",
    colors: {
      primary: "#0a0a0a",
    ...
    tags: ["labios", "neon", "sensual", "nocturno"],
    popular: true,
  },
  {
    id: "fort-party",
    name: "Fort Party",
    category: "Opulencia",
    description: "Estilo Ricardo Fort. Dorado, champagne, exceso y glamour total.",
    type: "despedida",
    style: "fortparty",
    colors: {
      primary: "#0d0d0d",
    ...
    tags: ["fort", "dorado", "champagne", "opulencia"],
    popular: true,
  },
  {
    id: "neon-drunk",
    name: "Neon Drunk",
    category: "Neon",
    description: "Carteles neon en la oscuridad. Estilo bar nocturno, tragos y luces.",
    type: "despedida",
    style: "neondrunk",
    colors: {
      primary: "#0a0014",
  ...
  },
  {
    ...
    name: "Pink Glam",
    category: "Glam",
    description: "Hot pink, glitter y glamour. Para la novia que quiere brillar.",
    type: "despedida",
    style: "pinkglam",
    colors: {
      primary: "#2d1b2e",
  ...
  },
  {
    ...
    name: "Pirata Night",
    category: "Fiesta",
    description: "Inspirada en 'Los Piratas'. Azul profundo, rojo y noche eterna.",
    type: "despedida",
    style: "piratanight",
    colors: {
      primary: "#000820",
