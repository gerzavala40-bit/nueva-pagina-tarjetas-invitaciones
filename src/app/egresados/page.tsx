    ...
    <section className="py-20 bg-[#0a0a0a] border-t border-[#7c3aed]/20" id="disenos">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 fu opacity-0 translate-y-8 transition-all duration-700">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Neon Grad */}
          <a href="#" className="group block"><div className="relative aspect-[3/4] rounded-lg overflow-hidden border-2 border-[#7c3aed]/20 hover:border-[#7c3aed] transition-all"><div className="absolute inset-0 bg-gradient-to-b from-[#0a0020] to-black"></div><div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 rounded-full opacity-20" style={{background:"radial-gradient(circle,#7c3aed,transparent)"}}></div><div className="relative z-10 h-full flex flex-col items-center justify-center text-center p-6"><div className="text-5xl mb-4">🎓</div><p className="text-[#7c3aed] text-[10px] tracking-[0.4em] uppercase mb-2">Promo 2025</p><p className="text-white text-xl font-black uppercase">NEON GRAD</p><p className="text-white/40 text-xs mt-2">Violeta &bull; Glow &bull; Fiesta</p></div><div className="absolute inset-0 bg-[#7c3aed]/0 group-hover:bg-[#7c3aed]/10 transition-all flex items-end justify-center pb-6"><span className="opacity-0 group-hover:opacity-100 text-white text-xs font-bold uppercase bg-[#7c3aed] px-4 py-2 transition-opacity">Proximamente</span></div></div><p className="text-white/60 text-sm font-bold mt-3">Neon Grad</p><p className="text-white/30 text-xs">The Future is Bright</p></a>
          {/* Gold Class */}
          <a href="#" className="group block"><div className="relative aspect-[3/4] rounded-lg overflow-hidden border-2 border-[#ffd700]/20 hover:border-[#ffd700] transition-all"><div className="absolute inset-0 bg-black"></div><div className="absolute inset-6 border border-dashed opacity-15" style={{borderColor:"#ffd700"}}></div><div className="relative z-10 h-full flex flex-col items-center justify-center text-center p-6"><div className="text-5xl mb-4">🏆</div><p className="text-[#ffd700] text-[10px] tracking-[0.4em] uppercase mb-2">Class of 2025</p><p className="text-white text-xl font-black uppercase">GOLD CLASS</p><p className="text-white/40 text-xs mt-2">Dorado &bull; Elegante &bull; Promo</p></div><div className="absolute inset-0 bg-[#ffd700]/0 group-hover:bg-[#ffd700]/10 transition-all flex items-end justify-center pb-6"><span className="opacity-0 group-hover:opacity-100 text-black text-xs font-bold uppercase bg-[#ffd700] px-4 py-2 transition-opacity">Proximamente</span></div></div><p className="text-white/60 text-sm font-bold mt-3">Gold Class</p><p className="text-white/30 text-xs">Elegancia & Celebracion</p></a>
          {/* Fiesta Total */}
          <a href="#" className="group block"><div className="relative aspect-[3/4] rounded-lg overflow-hidden border-2 border-[#10b981]/20 hover:border-[#10b981] transition-all"><div className="absolute inset-0 bg-gradient-to-b from-[#001a0a] to-black"></div><div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 rounded-full opacity-15" style={{background:"radial-gradient(circle,#10b981,transparent)"}}></div><div className="relative z-10 h-full flex flex-col items-center justify-center text-center p-6"><div className="text-5xl mb-4">🎉</div><p className="text-[#10b981] text-[10px] tracking-[0.4em] uppercase mb-2">Egresados 2025</p><p className="text-white text-xl font-black uppercase">FIESTA TOTAL</p><p className="text-white/40 text-xs mt-2">Verde &bull; Energia &bull; Descontrol</p></div><div className="absolute inset-0 bg-[#10b981]/0 group-hover:bg-[#10b981]/10 transition-all flex items-end justify-center pb-6"><span className="opacity-0 group-hover:opacity-100 text-white text-xs font-bold uppercase bg-[#10b981] px-4 py-2 transition-opacity">Proximamente</span></div></div><p className="text-white/60 text-sm font-bold mt-3">Fiesta Total</p><p className="text-white/30 text-xs">Pura energia</p></a>
        </div>
      </div>
    </section>
